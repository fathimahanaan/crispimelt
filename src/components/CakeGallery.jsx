...
<h1 className="text-lg sm:text-2xl md:text-4xl font-sans font-semibold mb-6 sm:mb-10 text-[#134739] drop-shadow-lg border-b-2 border-[#9dbbd5] w-fit mx-auto tracking-tight">
  Our Gallery
</h1>
